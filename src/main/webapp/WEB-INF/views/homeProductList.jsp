    ...
    <div class="col mb-5">
        <div class="card h-100">
            ...
            <c:choose>
                <c:when test="${not empty product.pImgpath}">
                    <a href="${pageContext.request.contextPath}/productDetail?pId=${product.pId}">
                        <img class="card-img-top" src="${pageContext.request.contextPath}${product.pImgpath}"
                        	 alt="${product.pName}" 
            ...
            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                <div class="text-center">
                    <button class="btn btn-outline-dark mt-auto" onclick="addToCart('${product.pId}')">장바구니 추가</button>
                </div>
            </div>
        </div>
    </div>
