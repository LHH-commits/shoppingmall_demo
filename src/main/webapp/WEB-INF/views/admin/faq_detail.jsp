    ...
    <div class="card">
        ...
        <div class="card-footer">
            <div class="d-flex justify-content-between">
                <div>
                    <a href="/admin/faq" class="btn btn-secondary">목록</a>
                </div>
                <div>
                    <a href="/admin/editFAQ?bId=${board.bId}&type=FAQ" class="btn btn-primary">수정</a>
                    <button type="button" class="btn btn-danger" onclick="deleteBoard(${board.bId}, 'FAQ')">삭제</button>
                </div>
            </div>
        </div>
    </div>
